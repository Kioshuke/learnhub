...
-- Xoá lớp (chỉ giáo viên lớp đó). Cascade xoá luôn danh sách thành viên.
...
-- Lớp của 1 user cụ thể (hiển thị trong Hồ Sơ Chi Tiết).
-- Chỉ user đó tự xem được, hoặc giáo viên/admin xem được (để theo dõi học sinh trong lớp).
