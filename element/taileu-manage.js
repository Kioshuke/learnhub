...
const CSS = [
  "",
  ".tml { --tml-blue:#2563eb; --tml-cyan:#0891b2; --tml-border:#e2e8f0; --tml-bg:#fff; --tml-sub:#64748b; --tml-text:#0f172a; --tml-soft:#f8fafc; min-width:0; }",
  ...
  ".tml-row{display:flex;align-items:flex-start;gap:12px;border:1px solid var(--tml-border);border-radius:14px;padding:12px 14px;margin-bottom:10px;background:#fff;transition:all .15s ease;min-width:0;flex-wrap:wrap}",
